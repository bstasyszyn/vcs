...
const (
	...
	tracingProviderEnvKey    = "VC_TRACING_PROVIDER"
	...
	tracingCollectorURLEnvKey    = "VC_TRACING_COLLECTOR_URL"
	...
	tracingServiceNameEnvKey    = "VC_TRACING_SERVICE_NAME"
	tracingServiceNameFlagUsage = "The name of the tracing service (for example, vcs1). Default: vcs. " +
