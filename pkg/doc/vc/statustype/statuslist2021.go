...
func (s *statusList2021Processor) CreateVCStatus(index, vcID, statusPurpose string, additionalFields ...vcapi.Field) *verifiable.TypedID {
...
func (s *statusList2021Processor) CreateVC(vcID string, listSize int, statusPurpose string, profile *vcapi.Signer) (*verifiable.Credential, error) {
