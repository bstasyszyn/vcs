...
func (s *BitstringStatusListProcessor) CreateVCStatus(index, vcID, statusPurpose string, additionalFields ...vcapi.Field) *verifiable.TypedID {
...
func (s *BitstringStatusListProcessor) CreateVC(vcID string, listSize int, statusPurpose string, profile *vcapi.Signer) (*verifiable.Credential, error) {
